...
namespace NPLForVisualStudio
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class NPLCommandSetBreakpoint
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NPLCommandSetBreakpoint"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private NPLCommandSetBreakpoint(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static NPLCommandSetBreakpoint Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new NPLCommandSetBreakpoint(package, commandService);
        }
